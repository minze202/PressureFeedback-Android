...
public class SampleCompressionPatterns {
    ...
    public static NumberPair[] pattern2Weak={
            new NumberPair(1,45), new NumberPair(2,3), new NumberPair(3,10)
    };
    ...
    public static NumberPair[] pattern4Weak={
            new NumberPair(1,50), new NumberPair(3,25), new NumberPair(3,10)
    };
    public static NumberPair[] pattern4Strong={
            new NumberPair(1,100), new NumberPair(3,50), new NumberPair(3,10)
    };
    ...
    public static NumberPair[] pattern5Strong={
            new NumberPair(1,20), new NumberPair(1,40), new NumberPair(1,60), new NumberPair(1,80), new NumberPair(1,100), new NumberPair(3,10)
    };
    static {
